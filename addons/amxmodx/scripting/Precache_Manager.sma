...
new const UnPrecache_SoundList[124][] =
{
...
public plugin_init() 
{
	...
	server_print("[Zombie: The Hero] Precache Manager: Reserved Slots (Model: %i | Sound: %i)", 512 - ArraySize(ArModel), 512 - ArraySize(ArSound))
}

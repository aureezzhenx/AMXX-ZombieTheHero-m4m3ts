...
#define V_MODEL "models/v_dragonsword_fix.mdl"
#define P_MODEL "models/p_dragonsword_baru.mdl"

#define CSW_DRAGONSWORD CSW_KNIFE
#define weapon_dragonsword "weapon_knife"
#define WEAPON_ANIMEXT "dragonsword" //"skullaxe"
...
{
    register_native("get_dragonsword", "native_get_dragonsword", 1)
}

public native_get_dragonsword(id)
{
        get_dragonsword(id)
}
...
public fw_CmdStart(id, uc_handle, seed)
{
	...
	if (CurButton & IN_ATTACK)
	{
		...
		set_weapons_timeidle(id, CSW_DRAGONSWORD, STAB_RESET_TIME + 0.1)
		set_player_nextattack(id, STAB_RESET_TIME + 0.1)
		set_weapon_anim(id, DS_ANIM_STAB)

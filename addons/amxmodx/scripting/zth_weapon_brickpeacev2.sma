...
#define PLUGIN "[Mileage] Primary: Brick Peace V2"
#define VERSION "1.0"
#define AUTHOR "Dias Pendragon Leon"

#define DAMAGE_A 38 // 60 for Zombie
...
new g_MsgCurWeapon, g_MsgAmmoX, g_Exp_SprId, g_SmokeSprId, g_MaxPlayers
...
public plugin_init()
{
	...
	g_BlockAR = zp_register_extra_item("Brick Peace V2", 0, ZP_TEAM_HUMAN)
}

public zp_extra_item_selected(id, itemid)
{
	// Check if the selected item matches any of our registered ones
	if (itemid == g_BlockAR) Get_BlockAR(id)
}
...
{
	register_native("Get_BlockAR", "Mileage_WeaponGet", 1)
}

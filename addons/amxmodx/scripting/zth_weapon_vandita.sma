...
#define PLUGIN "[Mileage] Primary: Vandita"
#define VERSION "1.0"
#define AUTHOR "Dias"
...
public plugin_init()
{
	...
	g_Weapon = zp_register_extra_item("Vandita", 0, ZP_TEAM_HUMAN)
...
public zp_extra_item_selected(id, itemid)
{
	...
	if (itemid == g_Weapon) Get_Vandita(id)
}
...
{
	register_native("Get_Vandita", "Mileage_WeaponGet", 1)
}
...
public fw_PlaybackEvent(flags, invoker, eventid, Float:delay, Float:origin[3], Float:angles[3], Float:fparam1, Float:fparam2, iParam1, iParam2, bParam1, bParam2)
{
	...
	emit_sound(invoker, CHAN_WEAPON, FIRE_SOUND, 1.0, 0.4, 0, 94 + random_num(0, 15))

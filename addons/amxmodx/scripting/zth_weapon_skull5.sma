...
#define PLUGIN "[Mileage] Primary: Skull-5"
#define VERSION "1.0"
#define AUTHOR "Dias Pendragon"

#define MILEAGE_CODENAME "skull5"

// Data Config
#define MODEL_V "models/v_skull5.mdl"
#define MODEL_P "models/p_primary.mdl"
#define MODEL_W "models/w_primary.mdl"

#define MODEL_W_OLD "models/w_g3sg1.mdl"
#define SOUND_FIRE "weapons/skull5-1.wav"

#define CSW_BASE CSW_G3SG1
#define weapon_base "weapon_g3sg1"

#define SUBMODEL 8 // can -1
#define WEAPON_CODE 1282015
#define WEAPON_EVENT "events/g3sg1.sc"

#define ANIME_SHOOT 1
#define ANIME_RELOAD 3 // can -1
#define ANIME_DRAW 4 // can -1
#define ANIME_IDLE 0 // can -1

/*
new const ExtraSounds[0][] =
{
	""
}*/
...
// Weapon Config
#define DAMAGE 80
#define ACCURACY 90 // 0 - 100 ; -1 Default
#define CLIP 24
#define BPAMMO 240
#define SPEED 0.3
#define RECOIL 3.0
...
public plugin_init()
{
	...
	// Get
	g_sk5 = zp_register_extra_item("Skull-5", 0, ZP_TEAM_HUMAN)
}

public zp_extra_item_selected(id, itemid)
{
	// Check if the selected item matches any of our registered ones
	if (itemid == g_sk5) Get_Skull5(id)
}
...
{
	register_native("Get_Skull5", "Mileage_WeaponGet", 1)
}
...
public fw_PlaybackEvent(flags, invoker, eventid, Float:delay, Float:origin[3], Float:angles[3], Float:fparam1, Float:fparam2, iParam1, iParam2, bParam1, bParam2)
{
	...
	emit_sound(invoker, CHAN_WEAPON, SOUND_FIRE, 1.0, 0.4, 0, 94 + random_num(0, 15))

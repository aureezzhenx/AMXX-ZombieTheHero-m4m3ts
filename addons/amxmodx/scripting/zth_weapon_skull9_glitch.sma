...
#define PLUGIN "[ZP] Extra Item: Skull-9"
#define VERSION "2.0"
#define AUTHOR "m4m3ts"

#define V_MODEL "models/v_skullaxex.mdl"
#define P_MODEL "models/p_skullaxe_2.mdl"

#define CSW_DRAGONSWORD CSW_KNIFE
#define weapon_dragonsword "weapon_knife"
#define WEAPON_ANIMEXT "skullaxe" //"skullaxe"

#define DRAW_TIME 0.7

#define SLASH_ROTATE_DAMAGE 400.0
#define SLASH_ROTATE_RADIUS 110.0
#define SLASH_ROTATE_POINT_DIS 80.0
#define SLASH_ROTATE_DELAY_TIME 1.0
#define SLASH_ROTATE_RESET_TIME 1.3

#define STAB_DAMAGE 800.0
#define STAB_RADIUS 100.0
#define STAB_POINT_DIS 60.0
#define STAB_TIME 1.0
#define STAB_RESET_TIME 1.9
...
{
	"weapons/skullaxe_deploy1.wav",
	"weapons/skullaxe1.wav",
	"weapons/skullaxe2.wav",
	"weapons/dragonsword_idle.wav",
	"weapons/skullaxe_slash1.wav",
	"weapons/skullaxe_slash1.wav",
	"weapons/skullaxe_stab.wav",
	"weapons/skullaxe_hwall.wav"
}
...
{
	register_native("get_skull9", "native_get_skull9", 1)
}
...
public Do_Slashing_Rotate(id)
{
	...
	{
		set_weapons_timeidle(id, CSW_DRAGONSWORD, 0.5)
...
fake_player_trace_attack(iAttacker, iVictim, &Float:fDamage)
{
	...
	if(using_ds(iAttacker)) fDamage *= 4.0
...
stock set_weapons_timeidle(id, WeaponId ,Float:TimeIdle)
{
	...
	set_pdata_float(entwpn, 48, TimeIdle + 1.5, OFFSET_LINUX_WEAPONS)
}
